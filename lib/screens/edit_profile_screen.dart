    ...
    return Scaffold(
      body: ListView(
        ...
        children: [
          ...
          const Row(
            children: [
              Expanded(child: NormalTextfield(hintText: "Gender",)),
              Expanded(child: NormalTextfield(hintText: "Birthday",)),
            ],
          ),
          const BoxTextfield(
            hintText: "Add something about yourself...",
          ),
          const NormalTextfield(hintText: "Website / Blog Address",),
          const BoxTextfield(
            hintText: "What genres do you like to write?",
          ),
          const Row(
            children: [
              Expanded(child: NormalTextfield(hintText: "Favorite Author",)),
              Expanded(child: NormalTextfield(hintText: "Favorite Book",)),
            ],
          ),
          const NormalTextfield(hintText: "Why do you write?",),
          const NormalTextfield(hintText: "What type of writer are you?",),
          const NormalTextfield(hintText: "What type do you write?",),
          const NormalTextfield(hintText: "How do you write?",),
          const NormalTextfield(hintText: "Where do you write?",),
